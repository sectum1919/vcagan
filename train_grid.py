...
def parse_args():
    ...
    parser.add_argument("--subject",
                        type=str,
                        default='multi-seen',
                        help=['multi-seen', 'multi-unseen', 's1', 's2', 's4', 's29'])
...
def train_net(args):
    ...
    args.checkpoint_dir = os.path.join(
        args.checkpoint_dir,
        f'{args.grid}_{args.subject}_{args.sample_rate}_{args.filter_length}_{args.hop_length}',
    )
    ...
    _ = validate(v_front, gen, post, val_data, fast_validate=False)
    train(v_front,
          gen,
          post,
          dis1,
